...
class ThrottledWorkerTest < ActiveSupport::TestCase
  ...
  test "do it" do
    ...
    chan.configuration = {:host => 'the_host', :port => 3200, :source_ton => 0, :source_npi => 1, :destination_ton => 0, :destination_npi => 1, :user => 'the_user', :password => 'the_password', :use_latin1 => '0', :mt_encodings => ['ascii'], :system_type => 'smpp'}
    chan.throttle = 5
    chan.save!
